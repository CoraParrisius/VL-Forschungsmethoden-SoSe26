...
date: today
date-format: "[Sommersemester] YYYY"

logo: img/ph-logo.svg
footer: Folien {{< iconify streamline:creative-commons-solid >}} {{< iconify fa6-brands:creative-commons-by >}} unter ogy.de/mvl-sose-2026
...
> Bei Fragen zur Vorlesung erreichen Sie uns unter [fome-lehre@ph-karlsruhe.de](mailto:fome-lehre@ph-karlsruhe.de)

Bevor Sie mit uns Kontakt aufnehmen, fragen Sie sich bitte kurz:

* Hätte ich das auch einfach eine:n Kommiliton:in fragen können?
* Steht die Info vielleicht auf irgend einer Folie?
* Kann ich die Frage auch kurz nach der VL persönlich klären?
...
![https://ogy.de/mvl-sose-2026](img/QR Code ogy-de-mvl-sose-2026.png){width=50%}
:::
...
* Mo 8 - 9:30, Raum 3.110, Nilani Suriakumar
* Mi 8 - 9:30, Raum 1.203, Ruben Rothenhäusler
* Do 12 - 13:30, Raum 1.013, Ruben Rothenhäusler
* Do 12 - 13:30, Raum 1.113, Lisa Mayer
* Fr 10 - 11:30, Raum 1.203, Ronja Barth

Siehe auch hier: [https://ogy.de/mvl-sose26-tutorien](https://ogy.de/mvl-sose26-tutorien)

InnovationSpace-Kurs: [https://innovationspace.ph-karlsruhe.de/course/view.php?id=717](https://innovationspace.ph-karlsruhe.de/course/view.php?id=717)


## Studienleistung: Versuchspersonenstunden {.smaller}

* Im Rahmen des Moduls Biwi-M2 sammeln Sie insgesamt 5 VPS, um Einblicke in empirische Bildungsforschung zu bekommen
* Sie nehmen dazu an Studien des Instituts für Psychologie und des Instituts für Empirische Bildungsforschung teil
* Die VPS sind vor Antritt der Klausur vollständig zu erbringen (Nicht-Erfüllung = Nicht-Zulassung zur Klausur!)
...
Die Teilnahme an wissenschaftlichen Studien ermöglicht Ihnen, Forschung aus Teilnehmendenperspektive kennenzulernen und ein besseres Verständnis für Methoden und wissenschaftliches Arbeiten zu entwickeln.

## Studienleistung: Versuchspersonenstunden {.smaller}

**Wie?**

* Treten Sie im InnovationSpace dem Kurs ["LA M2 VPS-Verbuchung"](https://innovationspace.ph-karlsruhe.de/course/view.php?id=705) bei
* _WICHTIG_: Registrieren Sie sich für die VPS-Verbuchung über den Link im InnovationSpace
* Sie finden dort eine Übersicht der aktuell angebotenen Studien
* Sie können jederzeit den aktuellen Stand Ihrer gesammelten VPS einsehen
...
* 4 **fakultative** Teilklausuren
   ...
   * Termine: **dienstags 16 Uhr, Hörsäle 1.013 und 1.113**
   
      * 12.05. Teilklausur 1 (Methodologie)
      * 09.06. Teilklausur 2 (Messen und Beschreiben)
      * 30.06. Teilklausur 3 (Effektstärken)
      * 14.07. Teilklausur 4 (Inferenzstatistik)
...
> Wir führen direkt in der Vorlesung kleinere und größere Experimente durch, besprechen deren Design und werten deren Ergebnisse aus. Die Teilnahme daran ist **obligatorisch**. **Freiwillig** können Sie zudem Ihre so generierten Daten für die wissenschaftliche Auswertung spenden {{< iconify mdi:donation >}} und VPS verbucht bekommen.
